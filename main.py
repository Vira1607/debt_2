...
# 
# Программа принимает на вход количество должников,
...
number_all = int(input('Введите количество должников: '))
debt = 0

for number_person in range(0, number_all + 1, 5): 
  print('Должник с номером ', number_person) 
